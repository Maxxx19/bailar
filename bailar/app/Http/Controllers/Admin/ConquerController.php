...
class ConquerController extends Controller
{
    ...
    {
        $dances = Dance::all();
        return view('admin.conquers.create', compact('dances'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $conquer->dances()->sync($request->dance_style);  
    ...
    public function show($id)
    {
        ...
        return view('admin.conquers.show', compact(['conquer', 'dances']));
    }
    ...
    {
        $dances = Dance::all();
        return view('admin.conquers.edit', compact(['conquer', 'dances']));
    }
