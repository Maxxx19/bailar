                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr><th> Місто </th><td> {{ $conquer->city }} </td></tr>
                                ...
                                <tr>
                                    <th> Стилі танців </th>
                                    <td>  
                                        @foreach($conquer->dances as $dn)
                                            {{$dn->title}}
                                        @endforeach
                                    </td>
                                </tr>
                                <tr><th> Дата початку </th><td> {{ $conquer->date_begin }} </td></tr>
                                <tr><th> Дата закінчення </th><td> {{ $conquer->date_end }} </td></tr>
                                <tr><th> Внесок учасника </th><td> {{ $conquer->contribution }} </td></tr>
                                <tr><th> Умови участі </th><td> {{ $conquer->conditions }} </td></tr>
                                <tr><th> Дата закінчення  реєстрації </th><td> {{ $conquer->date }} </td></tr>
