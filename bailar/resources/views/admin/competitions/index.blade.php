                                ...
                                @foreach($competitions as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/members/'. $item->id .'/'. 'competitions') }}" title="Переглянути учасників"><button class="btn btn-primary btn-sm"><i class="fas fa-user-friends"></i> Учасники</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
