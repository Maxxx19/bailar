                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr><th> Дата народження</th><td> {{ $dancepartner->age }} </td></tr>
                                <tr><th> Досвід</th><td> {{ $dancepartner->experience }} </td></tr>
                                <tr><th> Участь у змаганнях  </th><td> {{ $dancepartner->participation}} </td></tr>
                                <tr><th> Про мене  </th><td> {{ $dancepartner->about_yourself}} </td></tr>
                                <tr><th> Номер телефону </th><td> {{ $dancepartner->number }}</tr>
                                <tr><th> Участь у змаганнях </th><td> {{ $dancepartner->participation }}</tr>
                                <tr><th> Про мене </th><td> {{ $dancepartner->about_yourself }}</tr>
                                </tbody>
                            </table>
                        </div>
