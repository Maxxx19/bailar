...
Route::resource('conquers', 'Api\ConquerController');
Route::resource('parties', 'Api\PartiesContorller');
Route::resource('news', 'Api\NewsController');
Route::resource('masterclasses', 'Api\MasterclassController');
Route::resource('aboutdances', 'Api\\AboutdanceController');